...
class AUINetworkModel: NSObject {
    public var uniqueId: String = UUID().uuidString
    public var host: String = DreamFlowContext.host
...
class AUIUploadNetworkModel: AUINetworkModel {
    ...
    public override init() {
        super.init()
        host = DreamFlowContext.debugBaseServerUrl
    }
