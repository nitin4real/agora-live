...
// public enum
class SAAlertNavigationController: UINavigationController, SAPresentedViewType {
...
class SAAlertViewController: UIViewController, SAPresentedViewType {
    var presentedViewComponent: SAPresentedViewComponent?
    ...
    convenience init(compent: SAPresentedViewComponent, custom: UIView, isLayout: Bool = false) {
        self.init()
