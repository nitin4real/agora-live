...
//#define DFToolBarHeight (DF_IS_IPAD ? (DF_IS_NOTCHED_SCREEN ? 70 : (DF_IOS_VERSION >= 12.0 ? 50 : 44)) : (DF_IS_LANDSCAPE ? PreferredValueForVisualDevice(44, 32) : 44) + SafeAreaInsetsConstantForDeviceWithNotch.bottom)

/// tabBar associated frame
//#define TabBarHeight (DF_IS_IPAD ? (DF_IS_NOTCHED_SCREEN ? 65 : (DF_IOS_VERSION >= 12.0 ? 50 : 49)) : (DF_IS_LANDSCAPE ? PreferredValueForVisualDevice(49, 32) : 49) + SafeAreaInsetsConstantForDeviceWithNotch.bottom)
