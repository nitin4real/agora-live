    ...
    var canvasType: ShowLiveCanvasType = .none {
        didSet {
            ...
            case .pk:
                ...
                localCanvasTopCons?.constant = 76 + Screen.DFSafeAreaTopHeight() + timerView.height + 15
                ...
                timer.scheduledSecondsTimer(withName: "pk", timeInterval: 1, queue: .main) { [weak self] _, duration in
                    ...
                    let maxTime: TimeInterval = TimeInterval(DreamFlowContext.shared.sceneConfig?.showpk ?? 120)
...
//                localUserBottomCons?.constant = -468 / 812 * Screen.height
    ...
    private func setupUI() {
        ...
        timerView.topAnchor.constraint(equalTo: topAnchor,
                                       constant: 76 + Screen.DFSafeAreaTopHeight()).isActive = true
