...
private let kTableViewBottomOffset: CGFloat = Screen.DFSafeAreaBottomHeight() + 109
...
class ShowRoomLiveView: UIView {
    ...
    private func createSubviews(){
        ...
        roomInfoView.snp.makeConstraints { make in
            let top = Screen.DFSafeAreaTopHeight()
        ...
        chatButton.snp.makeConstraints { make in
            let bottomOffset = Screen.DFSafeAreaBottomHeight() + 4
            make.left.equalTo(15)
