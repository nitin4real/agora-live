...
extension String {
    var show_localized: String {
        ...
        if let ret = DreamFlowContext.shared.localizedCache[cacheKey] {
            return ret
        }
        guard let bundlePath = Bundle.main.path(forResource: "DreamFlow", ofType: "bundle"),
...
//        }
        ...
        DreamFlowContext.shared.localizedCache[cacheKey] = retStr
        return retStr
    }
}
